...
(49, 7, 'fd32h3212', '9337237678', 'kedia', 'h4l7852', 'ad1', 'ad2', NULL, NULL, NULL, 2, 536, 4, 108, '2022-06-20 12:31:37'),
(48, 2, 'fd32h3212', '9337237678', 'kedia', 'h4l7852', 'ad1', 'ad2', NULL, NULL, NULL, 2, 536, 3, 109, '2022-06-18 09:30:33');
...
--
-- Table structure for table `multi_permit`
--

DROP TABLE IF EXISTS `multi_permit`;
CREATE TABLE IF NOT EXISTS `multi_permit` (
...
--
-- Dumping data for table `multi_permit`
--

INSERT INTO `multi_permit` (`tc_id`, `p_id`, `com_id`, `q_id`, `weight`, `a_weight`, `trade_value`) VALUES
(1, 'PP19', 2, 1, 50, 45, 45000),
(2, 'PP17', 2, 1, 50, 45, 45000),
(3, 'A43', 2, 1, 40, 5, 16000),
(4, 'A44', 2, 1, 40, 5, 16000),
(5, 'A45', 2, 1, 40, 5, 16000),
(6, 'A46', 2, 1, 40, 5, 16000),
(7, 'A47', 2, 1, 40, 5, 16000),
(8, 'A48', 2, 1, 40, 5, 16000),
(9, 'A48', 8, 1, 24, 6, 16000),
(15, 'A49', 10, 1, 0, 30, 150000),
(14, 'A49', 8, 1, 63, 7, 150000),
(12, 'P38', 8, 1, 24, 5, 1500),
(13, 'P38', 2, 1, 40, 5, 750);
...
(33, 'kk', 'uuuuuuuu', 'dd', 'ss', 2, 536, 2, 3, 10, 1504, 'temp', 'matura', 'kashi', 'or12 mf1478', '2022-06-20 10:01:00', '2022-06-25 10:04:00', '2022-06-20 10:00:02', '2022-06-20 10:00:02', NULL, 4, '1478523690', 1, 0, NULL),
(38, 'kk', 'h4l7852', 'dd', 'ss', NULL, 536, 2, 3, NULL, NULL, 'ok', 'matura', 'kashi', 'or12 mf1478', '2022-06-20 12:01:00', '2022-07-09 12:02:00', '2022-06-20 11:59:13', '2022-06-20 11:59:13', NULL, 4, '1478523690', 1, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `p_permit` (
  ...
  `b_qty` int(11) DEFAULT NULL,
  `a_qty` int(11) DEFAULT NULL,
  `t_id` int(11) NOT NULL,
  `mfee` int(11) DEFAULT NULL,
  `trade_val` int(11) DEFAULT NULL,
  `ad1` varchar(255) NOT NULL,
  `ad2` varchar(255) NOT NULL,
...
INSERT INTO `p_permit` (`id`, `c_id`, `q_id`, `b_qty`, `a_qty`, `t_id`, `mfee`, `trade_val`, `ad1`, `ad2`, `veh_no`, `mobile`, `from_date`, `to_date`, `invoice`) VALUES
...
(19, NULL, NULL, NULL, NULL, 109, NULL, NULL, 'wwww', 'qqqqq', 'fd32h3212', '9337237678', '2022-06-17 15:05', '2022-06-22 15:05', 'h4l7852');
...
(109, 'kk', 2, 535, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5, NULL, 38, '2022-06-13 11:57:14', '2022-06-13 11:57:14', 4, '95,96,97'),
...
(93, 108, 8, 1, 70, 63, 21000, 630, 'Sales'),
(94, 108, 10, 1, 30, 0, 1500, 45, 'Sales'),
(95, 109, 2, 1, 45, 35, 45000, 225, 'Stock'),
(96, 109, 8, 1, 30, 19, 9000, 270, 'Sales'),
(92, 108, 2, 1, 50, 50, 7500, 225, 'Sales'),
